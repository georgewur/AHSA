...
When the size "watershed" of the river is known, the side inflow can be calculated as: $I = \frac{Q}{L_{river}}$ with $Q$ being the total discharge entering the river from the watershed aan $L$ distributed over the length of the river.
