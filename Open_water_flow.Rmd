...
In de previous assignment the downstream water level was given. Now we will calculate the water level downstream of a weir. The weir is a simple rectangular weir with a discharge coefficient of 0.62.
