...
plot(soil.set$Clay$ThetaS,soil.set$Clay$ThetaR,type="l",col="red",ylim=c(0,1),xlim=c(0,1),xlab="Water content",ylab="Pressure head")
...
$$
\text{Constant} = \frac{\partial}{\partial z} \left\{ K(\psi) \left ( \frac{\partial \psi}{\partial z} +1 \right) \right\}
$$
And since this derivative $\frac{\partial}{\partial z}$ is zero for now but is actually the flux rate. The equation simplifies to:
